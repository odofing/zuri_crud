...
app.use('/zuri-crud', postRoute);
 ...
 mongoose.connect(`mongodb+srv://odofing:xgMFSXculTQd9rSu@mongotesting.1lqon.mongodb.net/ZURI_CRUD?retryWrites=true&w=majority`,  {useNewUrlParser: true, useUnifiedTopology: true}, () => console.log('connected to remote db!'))
